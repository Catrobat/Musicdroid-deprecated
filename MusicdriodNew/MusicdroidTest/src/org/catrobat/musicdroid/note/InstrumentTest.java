...
public class InstrumentTest extends TestCase {
	...
	public void testProgram() {
		InstrumentMock[] instruments1 = InstrumentMock.values();
		Instrument[] instruments2 = Instrument.values();
		
		assertEquals(instruments1.length, instruments2.length);
		
		for (int i = 1; i < instruments1.length; i++) {
			assertEquals(instruments1[i].getProgram(), instruments2[i].getProgram());
		}
	}
	
	private enum InstrumentMock {
		...
		private InstrumentMock(int program) {

...
public class DrumSoundRowTest extends ActivityInstrumentationTestCase2<MainActivity> {
	...
	LayoutDrumSoundRow layout = null;
	...
	public void testBeatButtonChangesOnClick() {
		...
		solo.sleep(1000);
		assertTrue(testButton.getDrawable().getConstantState()
	...
	public void testSpinnerTextChangesOnLongClick() {
		...
		assertFalse(textBeforeSpinnerAction.equals(spinner.getSelectedItem()));
		assertTrue(((String) spinner.getSelectedItem()).equals(getActivity().getResources().getString(
				R.string.tambourine)));
	}

...
public class DrumsLayoutManagerTest extends ActivityInstrumentationTestCase2<MainActivity> {
	...
	public void testMapIsPopulatedCorrectly() {
		...
		assertTrue(stringToDrumTypeMap.containsKey(getActivity().getResources().getString(
				DrumType.BASE_DRUM.getNameResource())));
		assertTrue(stringToDrumTypeMap.containsKey(getActivity().getResources().getString(
				DrumType.SNARE_DRUM.getNameResource())));
		assertTrue(stringToDrumTypeMap.containsKey(getActivity().getResources().getString(
				DrumType.SNARE_DRUM_HARD.getNameResource())));
		assertTrue(stringToDrumTypeMap.containsKey(getActivity().getResources().getString(
				DrumType.HIGH_HAT_CLOSED.getNameResource())));
		assertTrue(stringToDrumTypeMap.containsKey(getActivity().getResources().getString(
				DrumType.HIGH_HAT_OPEN.getNameResource())));
		assertTrue(stringToDrumTypeMap.containsKey(getActivity().getResources().getString(
				DrumType.TAMBOURINE.getNameResource())));
		assertTrue(stringToDrumTypeMap.containsKey(getActivity().getResources().getString(
				DrumType.TOM_HIGH.getNameResource())));
		assertTrue(stringToDrumTypeMap.containsKey(getActivity().getResources().getString(
				DrumType.TOM_LOW.getNameResource())));
		assertTrue(stringToDrumTypeMap.containsKey(getActivity().getResources().getString(
				DrumType.CRASH_ONE.getNameResource())));
		assertTrue(stringToDrumTypeMap.containsKey(getActivity().getResources().getString(
				DrumType.CRASH_TWO.getNameResource())));
	}

	public void testMappingIsCorrect() {
		HashMap<String, DrumType> stringToDrumTypeMap = layoutManager.getStringToDrumTypeMap();
		DrumType type = stringToDrumTypeMap.get(getActivity().getResources().getString(
				DrumType.BASE_DRUM.getNameResource()));
		...
		type = stringToDrumTypeMap.get(getActivity().getResources().getString(
				DrumType.SNARE_DRUM_HARD.getNameResource()));
		...
		type = stringToDrumTypeMap
				.get(getActivity().getResources().getString(DrumType.HIGH_HAT_OPEN.getNameResource()));

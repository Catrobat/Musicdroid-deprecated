...
public enum Octave {
	...
	SUB_CONTRA_OCTAVE(new NoteName[] {
			NoteName.A0, NoteName.A0S,
			NoteName.B0}),
	CONTRA_OCTAVE(new NoteName[] {
	...
	THREE_LINE_OCTAVE(new NoteName[] {

...
public enum SoundType {
	PIANO(R.string.menu_item_piano, R.drawable.piano_button, R.string.help_menu_new_piano,
			R.color.sound_view_piano_color, R.color.sound_view_piano_expanded_color), DRUMS(R.string.menu_item_drums,
			R.drawable.drum_button, R.string.help_menu_new_drums, R.color.sound_view_drums_color,
			R.color.sound_view_drums_expanded_color), MIC(R.string.menu_item_mic, R.drawable.mic_button,
			R.string.help_menu_new_recording, R.color.sound_view_mic_color, R.color.sound_view_mic_expanded_color);

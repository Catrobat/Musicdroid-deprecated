...
public enum DrumType {
	BASE_DRUM(
			R.string.base_drum, R.raw.base_drum), 
	SNARE_DRUM(
			R.string.snare_drum, R.raw.snare_drum),
    SNARE_DRUM_HARD(
    		R.string.snare_drum_hard, R.raw.snare_drum_hard),
	HIGH_HAT_CLOSED(
			R.string.high_hat_closed, R.raw.high_hat_closed),
	HIGH_HAT_OPEN(
			R.string.high_hat_open, R.raw.high_hat_open),
	TOM_HIGH(
			R.string.high_tom, R.raw.tom_high),
	TOM_LOW(
			R.string.low_tom, R.raw.tom_low),
    CRASH_ONE(
			R.string.crash_one, R.raw.crash_one),
    CRASH_TWO(
			R.string.crash_two, R.raw.crash_two),
	TAMBOURINE(
			R.string.tambourine, R.raw.tambourine
			);

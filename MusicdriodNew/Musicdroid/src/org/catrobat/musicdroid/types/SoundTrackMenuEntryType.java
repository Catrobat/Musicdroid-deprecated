...
public enum SoundTrackMenuEntryType {
	EDIT(R.string.sound_track_menu_entry_edit, R.string.help_sound_track_menu_entry_edit), DELETE(
			R.string.sound_track_menu_entry_delete, R.string.help_sound_track_menu_entry_delete), COPY(
